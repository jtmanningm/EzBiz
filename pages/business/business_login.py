# /pages/business/auth/business_login.py
import streamlit as st
import sys
sys.path.append('/Users/jeremymanning/Documents/Ez_Biz')
    ...
    with st.form("login_form"):
        ...
        if submit:
            ...
            if success:
                ...
                st.session_state.page = 'service_selection'  # Changed to service_selection
                st.session_state.show_settings = False  # Ensure settings are not shown initially
                st.rerun()
            else:
                st.error(message)